 ...
 * TradingPanel - 交易面板组件
 *
 * 基于Trading组件改造，适配右侧面板布局（宽度约420px）
 * 主要变化：
 * 1. 移除外层 sub-tab-container 容器
 * 2. 调整布局为垂直滚动（适合窄屏面板）
 * 3. 保留所有业务逻辑和数据绑定
 */
export default function TradingPanel() {
  ...
  return (
    <div className="trading-panel-content">
      ...
      {/* Order Panel */}
      <section className="band trading-order-section">
      ...
      {/* Holdings Table */}
      <section className="band trading-positions-section">
        <div className="panel">
          <div className="panel-head">
            <div>
            ...
            <table>
              ...
              <tbody>
                {positions.map((record: any) => (
                  ...
                  >
                    <td><div className="symbol-title"><span className="symbol-code">{record.symbol}</span></div></td>
      ...
      {/* Trade History */}
      <section className="band trade-history-section">
        <div className="panel">
          <div className="panel-head">
            <div>
