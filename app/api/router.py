...
from app.api.routes import dashboard, discovery, journals, macro, market_data, market_events, news, portfolios, scans, scores, signal_rules, sim_accounts, symbols, system, trade_setups, watchlists
