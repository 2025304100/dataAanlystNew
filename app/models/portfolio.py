...
from sqlalchemy import CheckConstraint, Date, DateTime, Double, Float, ForeignKey, Integer, String, Text, UniqueConstraint
...
class Portfolio(Base):
    ...
    total_capital: Mapped[float] = mapped_column(Double)  # TD4（0057）账务金额列 Double
...
class Position(Base):
    ...
    market_value: Mapped[float] = mapped_column(Double, default=0)  # TD4（0057）账务金额列 Double
